...
## UART Initialisation and UART Transaction
  The MAX78000 provided multiple UART ports for communication, with each UART initialisation and transaction register and address being different. A self-defined header and source file, 
